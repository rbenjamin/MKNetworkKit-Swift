...
class AppDelegate: UIResponder, UIApplicationDelegate, UISplitViewControllerDelegate {
  ...
  func application(_ application: UIApplication, handleEventsForBackgroundURLSession identifier: String, completionHandler: @escaping () -> Void) {
    ...
    if httpbinHost.backgroundSessionIdentifier == identifier {
      httpbinHost.backgroundSessionCompletionHandler = completionHandler
    }

    if flickrHost.backgroundSessionIdentifier == identifier {
      flickrHost.backgroundSessionCompletionHandler = completionHandler
    }
  }
